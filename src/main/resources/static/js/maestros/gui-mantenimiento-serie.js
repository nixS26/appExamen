...
function cargarComboTipoDocumentoModal() {
    $.ajax({
        url: '/appExamen/api/tipos-documento', //
        method: 'GET',
        success: function (data) {
            let combo = $('#modalTipoDocumento');
            combo.empty();
            combo.append('<option value="">-- Seleccione --</option>');
            $.each(data, function (i, item) {
                combo.append('<option value="' + item.codigo + '">' + item.descripcion + '</option>');
            });
        },
