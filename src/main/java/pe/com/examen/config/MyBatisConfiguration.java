...
@Configuration
@MapperScan(basePackages = {"pe.com.examen.repository"}, sqlSessionFactoryRef = "sqlSessionFactory")
public class MyBatisConfiguration {
    public static final String TYPE_ALIASES_PACKAGE = "pe.com.examen";
    public static final String TYPE_HANDLERS_PACKAGE = "pe.com.examen.handler";
    ...
    public DataSource oracleJndiDataSource() throws IllegalArgumentException, NamingException {
        ...
        bean.setJndiName("java:comp/env/jdbc/ExamenDS");
